...
| Metric | Value |
|--------|-------|
| **Both methods significant** | 602 species (97.0%) |
| **Linear only significant** | 0 species (1.1%) |
| **Logistic only significant** | 1 species (1.6%) |
| **P-value correlation** | r = -0.0278 |
| **Effect size correlation** | r = -0.0468 |
